...
# https://docs.microsoft.com/en-gb/azure/dns/dns-domain-delegation
# https://docs.microsoft.com/en-gb/azure/dns/dns-delegate-domain-azure-dns

# Point NS records for the domain to ns.babosbird.com
